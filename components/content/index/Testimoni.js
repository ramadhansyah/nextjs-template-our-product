            ...
            <div className="row">
                <div className="col-lg-6">
                    <div className="image-container">
                        <img className="img-fluid" src="/static/images/testimonials-2-men-talking.svg" alt="alternative"/>
                    </div> 
                </div> 
                <div className="col-lg-6">
                    <h2>Testimonials</h2>
                        ...
                        <div className="swiper-container card-slider">
                            <div className="swiper-wrapper">
                                ...
                                <div className="swiper-slide">
                                    <div className="card">
                                        <img className="card-image" src="/static/images/testimonial-1.svg" alt="alternative"/>
                                ...
                                <div className="swiper-slide">
                                    <div className="card">
                                        <img className="card-image" src="/static/images/testimonial-2.svg" alt="alternative"/>
                                        <div className="card-body">
                                ...
                                <div className="swiper-slide">
                                    <div className="card">
                                        <img className="card-image" src="/static/images/testimonial-3.svg" alt="alternative"/>
                                        <div className="card-body">
