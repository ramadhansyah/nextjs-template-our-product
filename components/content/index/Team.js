                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="team-member">
                                <div className="image-wrapper">
                                    <img className="img-fluid" src="/static/images/team-member-1.svg" alt="alternative" />
                                </div>
                            ...
                            <div className="team-member">
                                <div className="image-wrapper">
                                    <img className="img-fluid" src="/static/images/team-member-2.svg" alt="alternative" />
                                </div>
                            ...
                            <div className="team-member">
                                <div className="image-wrapper">
                                    <img className="img-fluid" src="/static/images/team-member-3.svg" alt="alternative" />
                                </div>
                            ...
                            <div className="team-member">
                                <div className="image-wrapper">
                                    <img className="img-fluid" src="/static/images/team-member-4.svg" alt="alternative" />
                                </div>
