    ...
    return (
        <>
            ...
            <div className="text-container">
                ...
                <p>When you first register for a Evolo account, and when you use the Services, we collect some <a className="turquoise" href="#your-link">Personal Information</a> about you such as:</p>
                <ul className="list-unstyled li-space-lg indent">
                    ...
                    <li className="media">
                        <i className="fas fa-square"></i>
                        <div className="media-body">A unique Evolo user ID (an alphanumeric string) which is assigned to you upon registration</div>
                    </li>
                    <li className="media">
                        <i className="fas fa-square"></i>
            ...
            <div className="text-container last">
                ...
                <p>Evolo Landing Page uses tracking technology on the landing page, in the Applications, and in the Platforms, including mobile application identifiers and a unique Hootsuite user ID to help us recognize you across different Services, to monitor usage and web traffic routing for the Services, and to customize and improve the Services. By visiting Evolo or using the Services you agree to the use of cookies in your browser and HTML-based emails. Cookies are small text files placed on your device when you visit a <a className="turquoise" href="#your-link">web site</a> in order to track use of the site and to improve your user experience.</p>
                <a className="btn-outline-reg" href="index.html">BACK</a>
            </div>
